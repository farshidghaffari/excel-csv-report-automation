...
Accepted rows with source row, normalized values, revenue, and reporting month

Rejected Rows

Invalid rows with source row and explicit rejection reasons

Monthly Summary

Quantity, revenue, average unit price, and order count by month

Category Summary

The same metrics grouped by category

Product Summary

The same metrics grouped by product

Report Info

Source file, input/accepted/rejected counts, total revenue, and date range
...
AI Workflows · APIs · Backend Systems# Excel / CSV Reporting Automation
